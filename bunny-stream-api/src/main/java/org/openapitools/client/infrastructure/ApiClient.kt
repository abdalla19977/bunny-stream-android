...
open class ApiClient(val baseUrl: String, val client: OkHttpClient = defaultClient) {
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
        if (requestConfig.headers["AccessKey"].isNullOrEmpty()) {
            if (apiKey["AccessKey"] != null) {
                if (apiKeyPrefix["AccessKey"] != null) {
                    requestConfig.headers["AccessKey"] = apiKeyPrefix["AccessKey"]!! + " " + apiKey["AccessKey"]!!
                } else {
                    requestConfig.headers["AccessKey"] = apiKey["AccessKey"]!!
                }
            }
        }
    }
